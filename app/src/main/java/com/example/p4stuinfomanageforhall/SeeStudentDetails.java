    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mFinalAssignStudentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                edited.put("Hall_Id",uSeatId.substring(0,1));
                edited.put("Floor_No",uSeatId.substring(1,2));
                edited.put("Room_No",uSeatId.substring(2,4));
                ...
                docRef1.update(edited1).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(SeeStudentDetails.this, "Profile updated", Toast.LENGTH_SHORT).show();
                        mFinalAssignStudentButton.setVisibility(View.INVISIBLE);
                    }
                });
        ...
        mAssignStudentButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Student_Id",mStudentId.getText().toString());
        ...
        mRemoveSeatFromStuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(SeeStudentDetails.this, "Hall Id "+hallId, Toast.LENGTH_SHORT).show();
                String floorNo=uniqueSeatId.substring(1,2);
                Toast.makeText(SeeStudentDetails.this, "Floor No "+floorNo, Toast.LENGTH_SHORT).show();
